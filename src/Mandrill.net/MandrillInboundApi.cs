...
namespace Mandrill
{
    ...
    internal partial class MandrillInboundApi
    {
        ...
        public IList<MandrillInboundSendResponse> SendRaw(string rawMessage, IList<string> to = null,
            string mailFrom = null, string helo = null, string clientAddress = null)
        {
            if (rawMessage == null) throw new ArgumentNullException(nameof(rawMessage));
            return
                MandrillApi.Post<MandrillInboundSendRawRequest, IList<MandrillInboundSendResponse>>(
                    "inbound/send-raw.json",
                    new MandrillInboundSendRawRequest()
                    {
                        RawMessage = rawMessage,
